 ...
 * Entertainment model.
 */
class EntertainmentModelHighlight extends JModelItem {
    ...
    protected function populateState() {
        $app = JFactory::getApplication('com_entertainment');

        // Load state from the request userState on edit or from the passed variable on default
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_entertainment.edit.highlight.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_entertainment.edit.highlight.id', $id);
        }
