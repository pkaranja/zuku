...
class ContentModelArticle extends JModelAdmin
{
	...
	public function save($data)
	{
		...
		if (parent::save($data))
		{
			...
			//Ptah: hack to add country and language support (UPDATE)
/*			$article_id = $data['id'];
			$zukucountry = json_encode($data['zukucountry']);

			$db->setQuery("UPDATE #__content SET zukucountry='".$zukucountry."' WHERE id='$article_id'");
			$db->execute();
*/
			return true;
		}
