...
<form action="<?php echo JRoute::_('index.php?option=com_content&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				<!-- Ptah: Hack to enable country and language form fields !-->
				<fieldset class="form-vertical">
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('zukucountry'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('zukucountry'); ?></div>
					</div>
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('zukulangauge'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('zukulangauge'); ?></div>
					</div>
				</fieldset>
