...
<?php endif;?>
		...
		<table class="table table-striped" id="productList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCTS_PRODUCTS_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCTS_PRODUCTS_LANGUAGE', 'a.language', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCTS_PRODUCTS_STARTING_PRICE', 'a.starting_price', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_PRODUCTS_PRODUCTS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
