...
<form action="<?php echo JRoute::_('index.php?option=com_epg&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="program-form" class="form-validate">
    <div class="row-fluid">
        <div class="span10 form-horizontal">
            <fieldset class="adminform">
            <h4>Upload EPG file</h4>
			...
			<h4>Or <br /> <br /> - Fill in program details -</h4>
			<div class="control-group">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('channelid'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('channelid'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('starting'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('starting'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('ending'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('ending'); ?></div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('actor'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('actor'); ?></div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('director'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('director'); ?></div>
			</div>
			<div class="control-group">
