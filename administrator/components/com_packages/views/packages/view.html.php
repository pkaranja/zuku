 ...
 */
class PackagesViewPackages extends JViewLegacy
{
	protected $items;
	...
	{
		require_once JPATH_COMPONENT.'/helpers/packages.php';

		$state	= $this->get('State');
		$canDo	= PackagesHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_PACKAGES_TITLE_PACKAGES'), 'packages.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_packages');
		}
        
        //Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_packages&view=packages');
	...
	protected function getSortFields()
	{
		...
		'a.packagename' => JText::_('COM_PACKAGES_PACKAGES_PACKAGENAME'),
		'a.price' => JText::_('COM_PACKAGES_PACKAGES_PRICE'),
		'a.product' => JText::_('COM_PACKAGES_PACKAGES_PRODUCT'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_PACKAGES_PACKAGES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_PACKAGES_PACKAGES_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_PACKAGES_PACKAGES_CREATED_BY'),
		);
	}
