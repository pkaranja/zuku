...
if ( $_CB_framework->myId() ) {
	...
	echo '<input type="submit" name="Submit" class="button'.$class_sfx.' yellow text-yellow" value="' . $buttonValue . '"' . $buttonStyle . ' />';
	echo '</span>';
...
*/
	...
	echo '<div class="input-group">
		  <span class="input-group-addon" style="padding:0 10px;"><i class="glyphicon glyphicon-user"></i></span>
		  <input type="text" placeholder="Email" name="username" data-validation="email" data-validation-error-msg="Please enter a valid E-mail" id="mod_login_username'.$id_sfx.'" class="inputbox'.$class_sfx.' col-xs-12 input-medium" size="'.$name_lenght.'"' . $bgstyleUser . ' />
		</div>';
	...
	echo '<div class="input-group">
		  <span class="input-group-addon" style="padding:0 10px;"><i class="glyphicon glyphicon-lock"></i></span>
		  <input type="password" placeholder="Password" name="passwd" data-validation="required" data-validation-error-msg="Please your password" id="mod_login_password'.$id_sfx.'" class="inputbox '.$class_sfx.'  col-xs-12 input-medium" value="" size="'.$pass_lenght.'"' . $bgstylePass . ' />
		</div>';
	...
	echo '<input type="submit" name="Submit" class="button'.$class_sfx.' text-yellow yellow col-xs-12 no-border padding10 bold" value="MY ZUKU"' . $buttonStyle . ' />';
	echo '</span>';
	...
	if ( $listFormatted ) {
		 echo '<br /><ul class="cbLoginLinksList">';
	}
	...
	if ( $urlLostPassword ) {
		...
		echo '<a href="'.$urlLostPassword.'" class="text-white mod_login'.$class_sfx.'">';
	...
	if ( $urlRegister ) {
		...
		//		echo _UE_NO_ACCOUNT . " ";
		//	}
		echo '<a href="'.$urlRegister.'" class="mod_login text-white '.$class_sfx.'">';
		if ( $show_remind_register_icons >= 1 ) {
